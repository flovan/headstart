...
exports = module.exports = {
	...
	cacheAsset: function (assetPath, isCommon, viewName) {
		cache = cache || {};

		if (isCommon) {
			cache.common = cache.common || [];
			cache.common.push(assetPath.split(cacheSplit).pop());
		} else {
			cache.view = cache.view || [];
			cache.view[viewName] = cache.view[viewName] || [];
			cache.view[viewName].push(assetPath.split(cacheSplit).pop());
		}
	},
