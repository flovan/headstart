...
exports = module.exports = {
	...
	logTasks: function () {
		console.log(
			...
			/*deps.chalk.white.underline('Build your project') +
			'\n\n' +
			deps.chalk.cyan('headstart build [flags]') +
			deps.chalk.grey(' or ') +
			deps.chalk.cyan('hs build [flags]') +
			'\n\n' +
			 +
			'\n\n' +
			*/
		...
		/*console.log(
			deps.chalk.white.underline('Start a new project') +
			'\n\n' +
			deps.chalk.cyan('headstart init [flags]') +
			deps.chalk.grey(' or ') +
			deps.chalk.cyan('hs init [flags]') +
			'\n\n' +
			...
			deps.chalk.white.underline('Information') +
			'\n\n' +
			deps.chalk.cyan('headstart [flags]') +
			deps.chalk.grey(' or ') +
			deps.chalk.cyan('hs [flags]') +
			'\n\n' +
