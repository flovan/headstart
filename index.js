...
// gulp.task('hint-script', function(cb)
// {
// 	if(!config.hint) cb(null);
...
// gulp.task('scripts-main', ['hint-script'], function()
// {
// 	return gulp.src([
// 				config.app + '/js/libs/jquery*.js'

// 			,	(isProduction ? '!' : '') + config.app + '/js/libs/dev/*.js'

// 			,	config.app + '/js/libs/patches/matchmedia.polyfill.js'
// 			,	config.app + '/js/libs/patches/matchmedia.addListener.js'
// 			,	config.app + '/js/libs/patches/respond.js'
// 			,	config.app + '/js/libs/patches/*.js'

// 			,	config.app + '/js/libs/*.js'
// 			,	config.app + '/js/core/*.js'
// 			,	config.app + '/js/*.js'
// 			,	'!' + config.app + '/js/view-*.js'
...
// gulp.task('scripts-view', ['hint-script'], function()
// {
...
// 	watch({ glob: [config.app + '/js/**/*.js', '!**/view-*.js'], emitOnGlob: false, name: 'JS-MAIN', emit: 'all' }, function() {
...
{
	// Throw in some Zalgo for kicks
	// When this task runs, something went wrong, as only specific tasks
	// are allowed to be executed through the CLI
	console.log(chalk.red('\nH̵̡̨̪̥̰͎̼̱͔ͮ̓̓ͯ̑ͫͩ͌̏̓̽ͭ́e̸̶͙̠̗̯̟̲͇̤̣̪̋͛̿ͬͨ̈́͋ͬ͌̓͟͠ ̵̡̢͚̰̼̳̤̰͉̼͒̿͛̀̿̑̆̋̔ͣͭͫ̍͡c̵̻͔̙̋̅͛̋ͤ̈́̐ͩͦ̋́ͪ̈́͟͜o͗̅̎ͬ͌҉̨̛͢҉͈͈̼͖͙̭̻̭m͉̼̫͕̓̒́̇ͫ͗̓̇̃̏ͬ͒͌ͯ͛͐͘͞ͅm̱̣̝̩̬̪̔̈̾ͯ̎ͩ̆̍̑̾̀̍ͩ̿́́͟ë̢͚̣̞͔͖͇̹̥͈̼͛̊͑͋̈ͩͭ̾ͩ̂͌̓̿̀ͅt̴̷̸̢̻̮̘̲͇͊̆͆ͮͧ̋̄͆h̶̶̢̛͉̗͚͇̹̫ͣ͆͐ͦ̇ͪ̒̄̐̐̏͜\n'));
});